...
/* Return the EXTI-fed state for the left/internal vertical far-side endstop. */
static bool ylyb_limit_active(void)
{
  return (limitSwitchState.ylyb != 0U);
}

/* Return the EXTI-fed state for the left/external vertical far-side endstop. */
static bool yleb_limit_active(void)
{
  return (limitSwitchState.yleb != 0U);
}

/* Return the EXTI-fed state for the right/internal vertical far-side endstop. */
static bool yrib_limit_active(void)
{
  return (limitSwitchState.yrib != 0U);
}

/* Return the EXTI-fed state for the right/external vertical far-side endstop. */
static bool yreb_limit_active(void)
{
...
/* Return the EXTI-fed state for the left horizontal far-side endstop. */
static bool zli_limit_active(void)
{
  return (limitSwitchState.zli != 0U);
}

/* Return the EXTI-fed state for the right horizontal far-side endstop. */
static bool zri_limit_active(void)
{
...
/* Report whether any vertical-axis far-side endstop is active. */
static bool vertical_far_limit_active(void)
{
...
/* Report whether any horizontal-axis far-side endstop is active. */
static bool horizontal_far_limit_active(void)
{
...
/* Decide if a movement must stop because a directional endstop is active. */
static bool limit_should_stop_axis(bool moving_positive, bool released_once, bool home_limit_active, bool far_limit_active)
{
  if (moving_positive)
  {
